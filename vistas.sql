...
WHERE Persona.idPersona = Medico.idPersona AND Especialidad.idEspecialidad = Medico.idEspecialidad;
...
WHERE Persona.idPersona = Paciente.idPersona;
...
WHERE Persona.idPersona = Usuario.idPersona;